...
export const BankingHero = () => {
  return (
    ...
    <section className="relative w-full flex flex-col items-center justify-center min-h-screen pt-32 pb-24 lg:pt-48 lg:pb-48 bg-white dark:bg-[#020617] overflow-hidden border-b border-slate-100 dark:border-slate-800">
      {/* Background Effects */}
      ...
      <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-30">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto text-center flex flex-col items-center">
          <SectionBadge text="BFSI Solutions" className="!bg-white dark:!bg-slate-800 !border-brand-100 dark:!border-slate-700 !mb-8" />
