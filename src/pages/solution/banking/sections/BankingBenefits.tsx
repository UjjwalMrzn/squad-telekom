...
export const BankingBenefits = () => {
  ...
  return (
    <section 
      ...
      // FIXED: Added dark:bg-slate-900 to alternate with the Hero section
    ...
    >
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <SectionBadge text="Financial Communication" className="!bg-slate-800/50 dark:!bg-slate-800 !border-slate-700 !text-brand-400 !mb-4 backdrop-blur-md" />
          <SectionHeader 
            align="center" 
            lightMode={true} 
