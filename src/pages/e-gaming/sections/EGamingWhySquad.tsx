...
export const EGamingWhySquad = () => {
  return (
    <section className="py-16 lg:py-20 bg-slate-50 relative overflow-hidden border-b border-slate-200">
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="max-w-4xl mb-12 lg:mb-16">
          ...
          <SectionHeader 
            ...
            titleClassName="!text-3xl md:!text-4xl lg:!text-5xl !font-bold !text-slate-900 !leading-[1.15] !mb-4"
            ...
            subtitleClassName="!text-base lg:!text-lg !text-slate-600 !font-medium"
          />
        </div>
        ...
        >
          ...
          <motion.div 
            variants={fadeUp}
            whileHover={{ y: -4 }}
            className="col-span-1 md:col-span-2 bg-white rounded-[2rem] p-4 lg:p-6 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] border border-slate-100 flex items-center gap-6 lg:gap-10 transition-transform duration-300"
          >
            ...
            <h3 className="text-xl lg:text-2xl font-bold text-slate-800 text-center flex-1 pr-4 lg:pr-8 leading-snug">
              900+ operator <br className="hidden sm:block" />
          ...
          <motion.div 
            variants={fadeUp}
            whileHover={{ y: -4 }}
            className="col-span-1 bg-gradient-to-br from-brand-400 to-brand-600 rounded-[2rem] p-8 shadow-lg shadow-brand-500/20 relative overflow-hidden transition-transform duration-300 flex flex-col group"
          >
          ...
          <motion.div 
            variants={fadeUp}
            whileHover={{ y: -4 }}
            className="col-span-1 bg-gradient-to-br from-emerald-400 to-brand-500 rounded-[2rem] p-8 shadow-lg shadow-brand-500/20 relative overflow-hidden transition-transform duration-300 flex flex-col group"
          >
          ...
          <motion.div 
            variants={fadeUp}
            whileHover={{ y: -4 }}
            className="col-span-1 bg-gradient-to-br from-brand-500 to-emerald-500 rounded-[2rem] p-8 shadow-lg shadow-brand-500/20 relative overflow-hidden transition-transform duration-300 flex flex-col group"
          >
          ...
          <motion.div 
            variants={fadeUp}
            whileHover={{ y: -4 }}
            className="col-span-1 bg-gradient-to-bl from-brand-600 to-brand-400 rounded-[2rem] p-8 shadow-lg shadow-brand-500/20 relative overflow-hidden transition-transform duration-300 flex flex-col group"
          >
            ...
            <h3 className="text-3xl lg:text-4xl font-bold text-white mb-1 relative z-10 tracking-tighter">12,000+ <span className="text-sm font-semibold tracking-normal block mt-1 opacity-90 uppercase">Brands Trust Us</span></h3>
            <div className="flex-grow" />
            <ArrowUpRight className="w-6 h-6 text-brand-100 mb-4 opacity-80 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
            <p className="text-sm font-medium text-white/90 relative z-10 leading-relaxed">
          ...
          >
            ...
            <h3 className="text-xl lg:text-2xl font-bold text-slate-800 text-center flex-1 pr-4 lg:pr-8 leading-snug">
              Constantly evolving to meet tomorrow's communication needs.
            </h3>
          </motion.div>
