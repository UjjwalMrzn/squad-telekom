...
export const SuccessStories = () => {
  return (
    ...
    <section className="py-24 lg:py-32 bg-white dark:bg-[#020617] relative overflow-hidden border-b border-slate-200 dark:border-slate-800">
        ...
        >
          {stories.map((story, index) => (
            <motion.div 
              ...
              className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-8 lg:p-10 relative overflow-hidden group cursor-pointer border border-slate-200 dark:border-slate-700 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_30px_60px_-15px_rgba(59,186,177,0.15)] hover:border-brand-300 transition-all duration-500 flex flex-col h-full min-h-[360px]"
            >
              
              <div className="absolute -top-6 right-4 text-[140px] font-serif leading-none text-brand-50/60 dark:text-brand-900/30 group-hover:text-brand-100 dark:group-hover:text-brand-800/40 transition-colors duration-500 pointer-events-none select-none z-0">
                &ldquo;
              </div>
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-center justify-between mb-10">
                  ...
                  <span className="text-xs font-bold text-slate-400 dark:text-slate-300 uppercase tracking-widest bg-white/80 dark:bg-slate-700 px-2 py-1 rounded backdrop-blur-sm">
                    {story.readTime}
                  </span>
                </div>

                <h3 className="text-[22px] font-extrabold text-slate-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors duration-300 leading-[1.35] tracking-tight mb-8">
                  {story.title}
                </h3>
                ...
                <div className="flex items-end justify-between gap-6 mt-4">
                  <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed max-w-[200px] line-clamp-2">
                    {story.excerpt}
                  </p>
                  
                  <div className="w-12 h-12 flex-shrink-0 rounded-full bg-brand-50 dark:bg-slate-700 border border-brand-100 dark:border-slate-600 flex items-center justify-center text-brand-600 dark:text-brand-400 group-hover:bg-brand-500 group-hover:border-brand-500 group-hover:text-white dark:group-hover:bg-brand-500 dark:group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-lg group-hover:shadow-brand-500/30">
