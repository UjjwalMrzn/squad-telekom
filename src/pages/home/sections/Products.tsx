...
const services = [
  ...
  // },
  {
    ...
    image: "https://media.idownloadblog.com/wp-content/uploads/2022/05/Holding-iPhone-with-Messages-app.jpg", 
    path: "/portfolio/a2p-messaging"
  },
  {
    title: "RCS Messaging",
    ...
    path: "/portfolio/rcs-messaging"
  },
  {
    title: "WhatsApp Business Messaging",
    description: "Launch rich media marketing campaigns that reach thousands of customers at once through verified business profiles.",
    iconColor: "text-green-500 dark:text-green-400",
    image: "https://images.unsplash.com/photo-1614680376408-81e91ffe3db7?q=80&w=600&auto=format&fit=crop", 
    path: "/portfolio/whatsapp-business-messaging"
  },
  {
    title: "Telegram Business Messaging",
    description: "Deliver promotional broadcasts and rich media at scale, backed by secure, verified message delivery.",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1711535767116-6bc0d7948fb9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", 
    path: "/portfolio/esim"
  },
  {
    title: "Voice OTP",
    description: "Securely route automated voice verification, OTPs, and critical alerts directly to your users globally.",
    bgColor: "bg-[#eff6ff] dark:bg-slate-800/60",
    iconColor: "text-blue-500 dark:text-blue-400",
    image: "https://indochinatelecom.vn/wp-content/uploads/2025/03/Voice-OTP.jpg", 
    path: "/portfolio/voice-otp"
  },
  {
    title: "Software",
    description: "Custom telecommunication software and platform tools designed for seamless enterprise integrations.",
...
export const Products = () => {
  ...
  return (
    <section id="products" className="py-16 lg:py-20 bg-white dark:bg-[#020617] relative overflow-hidden border-b border-slate-100 dark:border-slate-800">      
      ...
      <div className="relative w-full max-w-[1700px] mx-auto group/slider px-2 sm:px-4 lg:px-6">
        <div className="absolute left-0 top-0 bottom-0 w-16 sm:w-24 bg-gradient-to-r from-white via-white/80 to-transparent dark:from-[#020617] dark:via-[#020617]/80 z-10 pointer-events-none hidden md:block" />
        <div className="absolute right-0 top-0 bottom-0 w-16 sm:w-24 bg-gradient-to-l from-white via-white/80 to-transparent dark:from-[#020617] dark:via-[#020617]/80 z-10 pointer-events-none hidden md:block" />
        ...
        <motion.button 
          ...
          onClick={() => scroll('left')}
          className="absolute left-2 md:left-4 lg:left-6 top-[45%] -translate-y-1/2 z-30 hidden md:flex w-14 h-14 rounded-full bg-white/95 dark:bg-slate-800/95 backdrop-blur-md border border-slate-200/80 dark:border-slate-700 items-center justify-center text-slate-700 dark:text-slate-300 hover:bg-brand-50 hover:text-brand-600 hover:border-brand-200 dark:hover:bg-slate-700 transition-all duration-300 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.2)] opacity-0 group-hover/slider:opacity-100 hover:scale-110 cursor-pointer"
        ...
        <motion.button 
          ...
          className="absolute right-2 md:right-4 lg:right-6 top-[45%] -translate-y-1/2 z-30 hidden md:flex w-14 h-14 rounded-full bg-white/95 dark:bg-slate-800/95 backdrop-blur-md border border-slate-200/80 dark:border-slate-700 items-center justify-center text-slate-700 dark:text-slate-300 hover:bg-brand-50 hover:text-brand-600 hover:border-brand-200 dark:hover:bg-slate-700 transition-all duration-300 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.2)] opacity-0 group-hover/slider:opacity-100 hover:scale-110 cursor-pointer"
        ...
        <div 
          ...
          className="flex overflow-x-auto gap-6 lg:gap-8 pt-4 pb-16 px-6 md:px-20 lg:px-24 snap-x snap-mandatory hide-scrollbar relative z-0"
        ...
        >
          {services.map((service, index) => {
            return (
              ...
              >
                <Link to={service.path} className="w-full h-full flex flex-col justify-between">
                  <div>
                  ...
                  <div className="inline-flex items-center text-sm font-bold tracking-widest uppercase transition-colors cursor-pointer w-fit mt-auto">
