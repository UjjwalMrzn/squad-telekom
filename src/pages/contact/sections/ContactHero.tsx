...
export const ContactHero = () => {
  ...
  return (
    <section 
      ...
      className="relative w-full pt-32 pb-24 lg:pt-48 lg:pb-32 bg-[#020617] overflow-hidden border-b border-slate-800 flex items-center justify-center min-h-[50vh] group/section cursor-default"
    >
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12 relative z-30 text-center flex flex-col items-center">
        ...
        >
          <SectionBadge text="Get In Touch" className="!bg-slate-800/50 !border-slate-700 !text-brand-400 !mb-8 backdrop-blur-md" />
          
          <h1 className="text-4xl sm:text-5xl lg:text-[4.5rem] font-bold text-white leading-[1.1] tracking-tight mb-6">
            Let's Build Something <br />
            <span className="text-brand-400">Extraordinary.</span>
          </h1>
          
          <p className="text-lg md:text-xl text-slate-400 font-medium leading-relaxed max-w-2xl mx-auto">
            Whether you need a custom enterprise solution, pricing details, or technical support, our team is ready to help you scale your global communication.
          </p>
        </motion.div>
      </div>
    </section>
