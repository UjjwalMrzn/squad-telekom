...
const features = [
  { 
    icon: Bot, 
    title: "Automated Bot Flows", 
    description: "Build custom bots for 24/7 customer support, lead collection, interactive menus, and instant query resolution." 
  },
  { 
    icon: Radio, 
    title: "Broadcast Channels", 
    description: "Reach unlimited subscribers simultaneously with rich news broadcasts, polls, flash sale alerts, and announcements." 
  },
  { 
    icon: Sparkles, 
    title: "Rich Media & Documents", 
    description: "Share high-resolution images, videos, large documents, inline buttons, and interactive media seamlessly." 
  },
  { 
    icon: ShieldCheck, 
    title: "Instant Verification & OTPs", 
    description: "Deliver time-sensitive verification codes and login OTPs over Telegram with high speed and low cost." 
  },
  { 
    icon: Zap, 
    title: "Targeted Campaigns", 
    description: "Segment your audience and trigger tailored automated messages based on customer behavior and preferences." 
  },
  { 
    icon: BarChart3, 
    title: "Detailed Campaign Analytics", 
    description: "Monitor broadcast view counts, bot interaction rates, click-throughs, and user feedback in real time." 
  }
];
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <SectionHeader
            align="center"
            lightMode={true}
            title="Telegram Messaging, Simplified"
            titleClassName="!text-3xl md:!text-4xl !font-bold !mb-4"
            subtitle="Engage a fast-growing global audience with automated bots, rich broadcasts, and multi-channel workflows designed for maximum conversion."
