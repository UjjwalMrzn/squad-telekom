...
const faqs = [
  {
    question: "Do users need the app?",
    answer: "Yes — Telegram requires the app, but adoption is widespread globally."
  },
  {
    question: "Bots vs. other channels — what’s unique?",
    answer: "Bots and channels enable automation and wide reach, delivering richer engagement than SMS or email."
  },
  {
    question: "Is Telegram secure for messaging?",
    answer: "Yes — Telegram offers strong privacy, encryption, and verified business credentials."
  },
  {
    question: "Can Squad integrate Telegram in multi-channel workflows?",
    answer: "Absolutely — Squad connects Telegram with SMS, Email, WhatsApp, Voice, and more for unified campaigns."
  },
  {
    question: "Can I send both 1-to-1 and broadcast messages?",
    answer: "Yes — Telegram supports personalized 1-to-1 interactions as well as large-scale broadcasts through channels."
  },
  {
    question: "Does Telegram support rich media and interactivity?",
    answer: "Definitely — you can share images, videos, polls, buttons, and even interactive bot flows for deeper engagement."
  }
];
