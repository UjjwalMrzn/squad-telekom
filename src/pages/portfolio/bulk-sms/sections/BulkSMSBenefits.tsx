...
const checklist = [
  "High Delivery Rate – Messages reach users quickly and reliably",
  "Affordable Pricing – Competitive bulk SMS rates for all business sizes",
  "Easy-to-Use Platform – No technical skills required to send bulk SMS",
  "API-Ready System – Ideal for automation and system messaging",
  "Scalable Infrastructure – From hundreds to millions of messages",
  "India-Focused Coverage – Built for Indian businesses and use cases"
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={fadeUp}>
              <SectionHeader
                align="left"
                title="Why Businesses Choose Bulk SMS"
                titleClassName="!text-3xl md:!text-4xl lg:!text-[2.75rem] !font-bold !text-slate-900 dark:!text-white !leading-[1.15] !mb-6"
                subtitle="Whether you're a startup or enterprise, Squad Bulk SMS helps you reach your customers with reliability and speed."
          ...
          >
            <div className="relative aspect-[4/3] lg:aspect-[16/10] rounded-[2rem] overflow-hidden bg-slate-200 dark:bg-slate-800 group w-full">
              <img
                ...
                alt="Bulk SMS messaging dashboard"
                loading="lazy"
