...
const faqs = [
  {
    question: "What is an E-SIM and how does it work?",
    answer: "An E-SIM (Embedded Subscriber Identity Module) is a programmable digital SIM chip built directly into a device's hardware. Instead of inserting a physical plastic card, cellular profiles are downloaded instantly Over-The-Air (OTA)."
  },
  {
    question: "Can Squad E-SIM profiles be managed remotely?",
    answer: "Yes. Enterprise administrators can assign, revoke, top-up, or reconfigure profiles across thousands of devices globally in real-time through our unified web dashboard or REST API."
  },
  {
    question: "Which devices support Squad E-SIM?",
    answer: "Squad E-SIM supports all GSMA-compliant devices, including modern iPhones, Android smartphones, iPads, cellular laptops, smartwatches, and enterprise IoT/M2M hardware."
  },
  {
    question: "How does E-SIM help reduce roaming costs?",
    answer: "Squad E-SIM dynamically connects to local tier-1 operator networks in 190+ countries, giving your team local data rates and bypassing expensive international roaming surcharges."
  },
  {
    question: "Is E-SIM secure for enterprise data?",
    answer: "Yes. Our E-SIM solution complies strictly with GSMA Security Accreditation Scheme (SAS) standards and utilizes bank-grade encryption for all credential downloads and network handshakes."
  },
  {
    question: "How quickly can we provision profiles for team members?",
    answer: "Profiles can be generated and provisioned instantaneously. Users receive a digital activation QR code or direct push notification to start using data immediately."
  }
];
