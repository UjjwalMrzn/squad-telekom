...
const features = [
  { 
    icon: Wifi, 
    title: "Remote OTA Provisioning", 
    description: "Download and activate cellular profiles Over-The-Air (OTA) in seconds without physical SIM swaps." 
  },
  { 
    icon: Globe2, 
    title: "Global Network Coverage", 
    description: "Access Tier-1 cellular networks across 190+ countries with local data rates and low latency." 
  },
  { 
    icon: Smartphone, 
    title: "Enterprise Mobility", 
    description: "Equip remote teams and corporate travelers with instant, secure mobile data wherever they operate." 
  },
  { 
    icon: Layers, 
    title: "IoT & M2M Connectivity", 
    description: "Deploy scalable E-SIM profiles for smart fleets, connected sensors, and industrial M2M hardware." 
  },
  { 
    icon: BarChart3, 
    title: "Centralized Data Portal", 
    description: "Monitor data pools, restrict usage caps, and manage active profiles through a unified management dashboard." 
  },
  { 
    icon: ShieldCheck, 
    title: "Bank-Grade Encryption", 
    description: "GSMA SAS-certified profile delivery ensuring secure credentials and encrypted payload transfers." 
  }
];
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <SectionHeader
            align="center"
            lightMode={true}
            title="Enterprise E-SIM Management, Built for Scale"
            titleClassName="!text-3xl md:!text-4xl !font-bold !mb-4"
            subtitle="Deploy global profiles remotely, optimize mobile data costs, and ensure uninterrupted cellular connection anywhere in the world."
