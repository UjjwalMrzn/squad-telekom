...
const faqs = [
  {
    ...
    answer: "RCS goes beyond plain text — it supports rich media, CTAs, branding, and interactive elements, creating app-like chat experiences directly in the phone’s native messaging app."
  },
  {
    question: "Do customers need to install an app?",
    answer: "No. RCS works natively within Android messaging apps, and supported operators enable it automatically for users."
  },
  {
    question: "What if RCS isn’t supported or fails?",
    answer: "No worries — Squad automatically falls back to SMS, ensuring your message always gets delivered without extra setup."
  },
  {
    question: "Is it secure?",
    answer: "Yes. RCS messaging uses verified sender IDs, encryption, and adheres to global compliance standards to keep communication safe."
  },
  {
    question: "Does RCS work on iOS devices?",
    answer: "Currently, RCS is mainly supported on Android. For iOS users, Squad ensures smooth fallback to SMS so you never lose reach."
  },
  {
    question: "What industries benefit most from RCS?",
    answer: "RCS is ideal for e-commerce, banking, travel, and retail — enabling brands to send interactive campaigns, booking updates, offers, and personalized support at scale."
  }
];

export const RCSMessagingFaq = () => {
