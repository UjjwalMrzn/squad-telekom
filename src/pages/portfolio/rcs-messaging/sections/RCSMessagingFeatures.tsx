...
const features = [
  { 
    icon: Sparkles, 
    title: "Rich Business Messaging", 
    description: "Send high-resolution images, video clips, audio clips, and interactive carousels directly inside native messaging apps." 
  },
  { 
    icon: MousePointerClick, 
    title: "Interactive Action Buttons", 
    description: "Empower users with quick-reply buttons, URL redirects, map location pins, and one-click CTA actions." 
  },
  { 
    icon: ShieldCheck, 
    title: "Verified Sender Profiles", 
    description: "Build instant trust with verified brand logos, custom sender names, and official security trust badges." 
  },
  { 
    icon: BellRing, 
    title: "OTP & Transactional Alerts", 
    description: "Deliver time-sensitive verification codes and transactional updates with automatic fallback to SMS." 
  },
  { 
    icon: MessageSquareShare, 
    title: "Conversational Engagement", 
    description: "Enable two-way conversational commerce, booking bots, and customer support flows seamlessly." 
  },
  { 
    icon: BarChart3, 
    title: "Real-Time Performance Analytics", 
    description: "Gain deep insights with precise read receipts, button click-through tracking, and engagement metrics." 
  }
];

export const RCSMessagingFeatures = () => {
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <SectionHeader
            align="center"
            lightMode={true}
            title="What You Can Do with RCS Messaging"
            titleClassName="!text-3xl md:!text-4xl !font-bold !mb-4"
            subtitle="Transform text threads into app-like interactive experiences. Squad RCS messaging lets you build rich, conversational touchpoints with guaranteed fallback."
