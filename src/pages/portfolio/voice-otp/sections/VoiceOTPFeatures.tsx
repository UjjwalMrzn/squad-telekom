...
const features = [
  { 
    icon: Volume2, 
    title: "Text-to-Speech (TTS) Engine", 
    description: "Synthesize dynamic verification PINs and personalized messages in 30+ regional languages effortlessly." 
  },
  { 
    icon: RefreshCw, 
    title: "Instant Fallback & Failover", 
    description: "Automatically trigger Voice OTP calls if an SMS OTP encounters delivery delays or network timeout." 
  },
  { 
    icon: ShieldCheck, 
    title: "Anti-Fraud & SIM-Swap Guard", 
    description: "Bypass SIM-swap exploits and SMS interception with secure, encrypted voice authentication channels." 
  },
  { 
    icon: PhoneCall, 
    title: "Customizable Call Flows", 
    description: "Configure DTMF keypress confirmations, repeated passcode prompts, and custom caller IDs." 
  },
  { 
    icon: Globe2, 
    title: "Tier-1 Voice Telephony", 
    description: "Direct carrier routing ensuring high call connection rates and ultra-clear audio quality globally." 
  },
  { 
    icon: BarChart3, 
    title: "Real-Time Telephony Analytics", 
    description: "Track call delivery speed, pickup rates, audio duration, and conversion metrics on a unified portal." 
  }
];

export const VoiceOTPFeatures = () => {
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <SectionHeader
            align="center"
            lightMode={true}
            title="High-Deliverability Voice Verification Engine"
            titleClassName="!text-3xl md:!text-4xl !font-bold !mb-4"
            subtitle="Bypass SMS network congestion and deliver time-sensitive security PINs via clear, multi-language automated voice calls."
