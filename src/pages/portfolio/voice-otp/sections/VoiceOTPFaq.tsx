...
const faqs = [
  {
    question: "What is Voice OTP and how does it work?",
    answer: "Voice OTP delivers dynamic authentication PINs and security passcodes via automated phone calls. When requested, our system calls the user and uses text-to-speech to speak the code clearly."
  },
  {
    question: "When should I use Voice OTP over SMS OTP?",
    answer: "Voice OTP is ideal as a high-conversion fallback when SMS delivery is delayed, blocked by DND registries, or affected by network congestion—ensuring zero user drop-off during login."
  },
  {
    question: "Can Voice OTP synthesize dynamic numbers and text?",
    answer: "Yes, our advanced Text-to-Speech (TTS) engine dynamically reads passcodes, account names, and numbers naturally in 30+ regional languages."
  },
  {
    question: "Does Voice OTP support keypress verification (DTMF)?",
    answer: "Yes! You can require users to press a specific key (e.g., 'Press 1 to hear your PIN again') to ensure an active human answered the call."
  },
  {
    question: "How does automatic SMS-to-Voice failover work?",
    answer: "If an SMS OTP is not delivered or confirmed within a specified timeout (e.g., 15 seconds), Squad's API automatically triggers a Voice OTP call as a seamless fallback."
  },
  {
    question: "Is Voice OTP secure against SIM-swapping and interception?",
    answer: "Yes. Voice OTP travels over encrypted telephony networks rather than standard SMS text channels, significantly mitigating SIM-swap attacks and SMS interception risks."
  }
];

export const VoiceOTPFaq = () => {
