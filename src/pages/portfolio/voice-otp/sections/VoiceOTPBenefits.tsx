...
const checklist = [
  "100% Delivery Reach – Never lose authentication requests to SMS filter blocks or DND restrictions",
  "Ultra-Fast Call Triggering – Calls initiate in under 3 seconds with localized, crystal-clear voice prompts",
  "Multi-Language Speech Engine – Convert dynamic PINs and messages across 30+ regional languages",
  "Smart Failover Integration – Automatically trigger Voice OTP whenever an SMS message times out",
  "Cost-Effective Pricing Model – Pay only for answered authentication calls with maximum conversion",
  "Bank-Grade Security Standards – Encrypted telephony streams preventing voice interception and fraud"
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={fadeUp}>
              <SectionHeader
                align="left"
                title="Why Enterprises Choose Squad Voice OTP"
                titleClassName="!text-3xl md:!text-4xl lg:!text-[2.75rem] !font-bold !text-slate-900 dark:!text-white !leading-[1.15] !mb-6"
                subtitle="Ensure frictionless account logins, transaction approvals, and 2FA authentication for high-value users even when SMS networks fail."
          ...
          >
            <div className="relative aspect-[4/3] lg:aspect-[16/10] rounded-[2rem] overflow-hidden bg-slate-200 dark:bg-slate-800 group w-full">
              <img
                ...
                alt="Voice Authentication Dashboard"
                loading="lazy"
