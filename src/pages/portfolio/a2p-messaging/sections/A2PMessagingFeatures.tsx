...
const features = [
  { 
    ...
    description: "Robust RESTful APIs for SMS, Voice, WhatsApp, and RCS to plug directly into your software stack." 
  },
  { 
    icon: Globe2, 
    title: "Global SMS Network", 
    description: "Connect with subscribers in over 180+ countries via direct operator partnerships and carrier routes." 
  },
  { 
    icon: Send, 
    title: "Transactional Messaging", 
    description: "Ensure guaranteed delivery of time-critical OTPs, account alerts, and security notifications." 
  },
  { 
    icon: ShieldCheck, 
    title: "Delivery Intelligence", 
    description: "Smart failover routing and real-time status tracking to eliminate message loss and latency." 
  },
  { 
    icon: Zap, 
    title: "Omnichannel Fallback", 
    description: "Automatically reroute undelivered SMS via WhatsApp or Voice to ensure 100% reach." 
  },
  { 
    icon: BarChart3, 
    title: "Performance Analytics", 
    description: "Granular delivery reports, open rates, and real-time campaign performance dashboards." 
  }
];

export const A2PMessagingFeatures = () => {
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <SectionHeader
            align="center"
            lightMode={true}
            title="All-in-One Messaging Platform, Built to Scale"
            titleClassName="!text-3xl md:!text-4xl !font-bold !mb-4"
            subtitle="Squad provides enterprise-grade A2P infrastructure designed to automate workflows, guarantee fast delivery, and handle billions of critical messages seamlessly."
