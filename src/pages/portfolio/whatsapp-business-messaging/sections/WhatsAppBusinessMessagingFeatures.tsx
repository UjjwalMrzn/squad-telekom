...
const features = [
  { 
    ...
    description: "Send tailored notifications, dynamic updates, and customized promotional offers directly to opted-in users." 
  },
  { 
    icon: Bot, 
    title: "Self-Service Support", 
    description: "Automate FAQs, booking queries, and order routing 24/7 with conversational AI chatbots." 
  },
  { 
    icon: Sparkles, 
    title: "Rich Media & Catalogs", 
    description: "Showcase interactive product carousels, payment links, PDFs, and location pins directly in chat." 
  },
  { 
    icon: BadgeCheck, 
    title: "Verified Green Badge", 
    description: "Build instant customer trust with official green checkmark verification and custom brand identity." 
  },
  { 
    icon: Megaphone, 
    title: "Broadcasting & Blasts", 
    description: "Launch targeted marketing campaigns and re-engagement broadcasts with high open rates." 
  },
  { 
    icon: BarChart3, 
    title: "Actionable Insights", 
    description: "Track message delivery, read receipts, button click-throughs, and overall campaign ROI." 
  }
];

export const WhatsAppBusinessMessagingFeatures = () => {
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <SectionHeader
            align="center"
            lightMode={true}
            title="Turn Conversations Into Real Conversions"
            titleClassName="!text-3xl md:!text-4xl !font-bold !mb-4"
            subtitle="Engage users where they feel most comfortable. Squad WhatsApp Business Messaging gives you the tools to automate, personalize, and scale customer communications."
