...
const faqs = [
  {
    question: "Do customers need to save our number?",
    answer: "No. With verified API accounts, your messages are delivered with your brand name and verified identity, ensuring trust and recognition."
  },
  {
    question: "Can we run promotions over WhatsApp?",
    answer: "Yes — provided users have opted in. You can run promotions, send catalogs, and broadcast campaigns while staying compliant."
  },
  {
    question: "Is the API developer-friendly?",
    answer: "Absolutely. Squad offers APIs, SDKs, detailed documentation, and sandbox environments for quick and seamless integration."
  },
  {
    question: "How does the API differ from the WhatsApp App?",
    answer: "The API enables automation, bulk messaging, chatbots, and enterprise system integrations — features not supported by the regular app."
  },
  {
    question: "Is there support for multiple languages?",
    answer: "Yes — the API allows you to send and receive messages in multiple languages, including regional scripts, for truly localized engagement."
  },
  {
    question: "How is compliance handled?",
    answer: "Squad ensures all WhatsApp campaigns follow opt-in requirements, GDPR, TCPA, and TRAI guidelines — keeping your outreach safe and regulation-ready."
  }
];

export const WhatsAppBusinessMessagingFaq = () => {
